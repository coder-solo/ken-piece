...
public class PieceShiroConfig {
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(pieceShiroRealm());
     ...
     */
    @Bean
    public PieceShiroRealm pieceShiroRealm() {
        PieceShiroRealm pieceShiroRealm = new PieceShiroRealm();
        return pieceShiroRealm;
    }
